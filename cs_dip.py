...
meas_loss_ = np.zeros((args.NUM_RESTARTS, args.BATCH_SIZE))
reconstructions_ = np.zeros((args.NUM_RESTARTS, args.BATCH_SIZE, args.NUM_CHANNELS, \
...
def dip_estimator(args):
	def estimator(A_val, y_batch_val, args):
		...
		x_hat = reconstructions_[ind_best] # choose best reconstruction from all restarts
